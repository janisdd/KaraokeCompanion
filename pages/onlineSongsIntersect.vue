...
<template>
  <main
    class="min-h-screen bg-slate-50 px-3 pt-4 sm:px-6 sm:pt-8 dark:bg-slate-950"
  ...
  >
    <div class="mx-auto max-w-5xl space-y-4">
      ...
      <section class="text-sm text-slate-600 dark:text-slate-300">
        <form class="space-y-4" @submit.prevent="comparePlaylist">
          ...
          <div class="flex flex-wrap items-center gap-4">
            ...
            <span v-else-if="compareResult" class="text-sm text-emerald-600 dark:text-emerald-300">
              {{ matches.length }} track(s) matched between {{ playlistServiceLabel }} and online songs
            </span>
          </div>
          <div
        ...
        <div v-if="compareResult" class="mt-2 border-t border-slate-200 pt-2 dark:border-slate-700">
